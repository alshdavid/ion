...
pub struct CallbackRegistry {
    pub worker_handle_active: AtomicBool,
    pub context_handle_active: RwLock<HashMap<usize, bool>>,
    pub worker_shutdown: Mutex<Vec<WorkerShutdownCallback>>,
    pub context_shutdown: Mutex<HashMap<usize, Vec<ContextShutdownCallback>>>,
}
