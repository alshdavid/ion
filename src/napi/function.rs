...
impl CallbackInfo {
    #[inline]
    pub fn new_raw(env: *mut Env, cb: napi_callback, cb_info: napi_callback_info) -> *mut Self {
...
pub fn create_function<'s>(
    ...
    let external = v8::External::new(scope, CallbackInfo::new_raw(env, cb, cb_info) as *mut _);
